...
describe('Complete MAVLink 2.0 packet', function() {
    ...
    it('encode gps_raw_int', function() {
        ...
        var reference = new Buffer.from([0xfd, 0x1e, 0x00, 0x01, 0x05, 0x2a, 0x96, 0x18, 0x00, 0x00, 0x15, 0xcd, 0x5b, 0x07, 0x00, 0x00, 0x00, 0x00, 0x00, 0x0c, 0xcf, 0x02, 0x40, 0xf4, 0x7b, 0x00, 0x50, 0xc3, 0x00, 0x00, 0x90, 0x19, 0xd6, 0x11, 0xd3, 0x04, 0xd2, 0x04, 0x03, 0x09, 0xe8, 0x87]);
    ...
    it('encode gps_raw_int with long integer', function() {
        ...
        // Create a buffer that matches what the Python version of MAVLink creates
        var reference = new Buffer.from([0xfd, 0x1e, 0x00, 0x01, 0x05, 0x2a, 0x96, 0x18, 0x00, 0x00, 0x01, 0x18, 0x3d, 0x9e, 0x59, 0x83, 0xfd, 0x0f, 0x00, 0x0c, 0xcf, 0x02, 0x40, 0xf4, 0x7b, 0x00, 0x50, 0xc3, 0x00, 0x00, 0x90, 0x19, 0xd6, 0x11, 0xd3, 0x04, 0xd2, 0x04, 0x03, 0x09, 0x6a, 0x79]);
        new Buffer.from(gpsraw.pack(this.mav)).should.eql(reference);
    });
    ...
    it('encode heartbeat', function() {
        ...
        // Create a buffer that matches what the Python version of MAVLink creates
         var reference = new Buffer.from([0xfd, 0x09, 0x00, 0x01, 0x07, 0x2a, 0x96, 0x00, 0x00, 0x00, 0x44, 0x00, 0x00, 0x00, 0x05, 0x03, 0x2d, 0x0d, 0x03, 0xa9, 0xf4]);
   ...
   it('encode BATTERY_STATUS, zeroed extensions', function() {
        ...
        var reference = new Buffer.from([0xfd, 0x24, 0x00, 0x01, 0xac, 0x01, 0x01, 0x93, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0xff, 0x7f, 0x2b, 0x31, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0x00, 0x00, 0x00, 0x00, 0x00, 0x64, 0x52, 0x43]);
  ...
  // in mavlink2, this packet has extensions, so being sure they work is useful.
   it('encode BATTERY_STATUS, non-zeroed extensions', function() {
        ...
        // at the moment we just zero-fill them and tweak the checksum...
         var reference = new Buffer.from([0xfd, 0x29, 0x00, 0x01, 0xac, 0x01, 0x01, 0x93, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0xff, 0x7f, 0x2b, 0x31, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0x00, 0x00, 0x00, 0x00, 0x00, 0x64, 0x02, 0x00, 0x00, 0x00, 0x01, 0x7d, 0x2a]); // revised checksum
 ...
 it('decode BATTERY_STATUS with array, and also zero-d extension bytes', function() {
        ...
        // Create a 'long' buffer that matches what the Python version of MAVLink creates
         var reference = new Buffer.from([0xfd, 0x31, 0x00, 0x01, 0xac, 0x01, 0x01, 0x93, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0xff, 0x7f, 0x2b, 0x31, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0x00, 0x00, 0x00, 0x00, 0x00, 0x64, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x52, 0x72]);
 ...
 it('decode BATTERY_STATUS with array, and also non-zerod extension bytes', function() {
        ...
        //   with incompat_flags = 0  and a valid crc
         var reference = new Buffer.from([0xfd, 0x29, 0x00, 0x01, 0x58, 0x0b, 0x0a, 0x93, 0x00, 0x00, 0xf8, 0xcd, 0x6d, 0x39, 0xc8, 0xce, 0x6d, 0x39, 0xf3, 0x44, 0x5b, 0x45, 0x5c, 0x45, 0x5d, 0x45, 0x5e, 0x45, 0x5f, 0x45, 0x60, 0x45, 0x61, 0x45, 0x62, 0x45, 0x63, 0x45, 0x64, 0x45, 0x6b, 0x49, 0x65, 0xa8, 0xeb, 0x2e, 0x48, 0xd5, 0x6d, 0x39, 0x7d, 0x00, 0xd6]);
        ...
        msg[0]._header.compat_flags.should.eql(1);
...
describe('MAVLink 2.1 32 bit system IDs', function() {
    ...
    it('round trips a 32 bit source system via the SYSID32 header', function() {
        ...
        packed[3].should.eql(this.mavlink20.MAVLINK_CFLAG_SYSID32); // compat_flags
    ...
    it('round trips a 32 bit target via the TARGETTED header', function() {
...
describe('MAVLink 2.0 message', function() {
    ...
    it('Can pack itself', function() {
        ...
        packed.should.eql([253, 9, 0, 1, 0, 0, 0, mavlink20.MAVLINK_MSG_ID_HEARTBEAT, 0, 0, // that bit is the header,
