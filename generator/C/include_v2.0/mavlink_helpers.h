 ...
 *
 * This function calculates the checksum, sets length, system id and compenent id correctly
 * and optionally signs the message.
 *
...
/**
 * @brief Finalize a MAVLink message for the given channel
 *
 * This function calculates the checksum, sets length, system id and compenent id correctly
 * and optionally signs the message.
 *
