...
class MAVFTPSetting:  # pylint: disable=too-few-public-methods
    ...
    def __init__(self, name: str, s_type: type, default) -> None:
        self.name = name
        self.type = s_type
...
class MAVFTP:  # pylint: disable=too-many-instance-attributes
    ...
    def cmd_ftp(self, args: list[str]) -> MAVFTPReturn:  # noqa: PLR0911 pylint: disable=too-many-branches,too-many-return-statements
        ...
        if args[0] == "set":
            ...
            return MAVFTPReturn("FTP command", FtpError.Success)
        if args[0] == "get":
    ...
    def cmd_get(self, args: list[str], callback=None, progress_callback=None) -> MAVFTPReturn:
        """Get file."""
